...
class Order extends Model
{
     ...
     */
    protected $fillable = ['total', 'address', 'user_id', 'ongkir', 'payment_image', 'payment_status', 'payment_notes', 'resi', 'order_status', 'jasa_kirim'];
    ...
    public function getOngkir(): int
    {
        return $this->attributes['ongkir'];
    }

    public function setOngkir(int $ongkir): void
    {
        $this->attributes['ongkir'] = $ongkir;
    }
